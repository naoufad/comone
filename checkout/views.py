...
ShippingMethodView=get_class('checkout.views','ShippingMethodView')
     ...
     def select_account(self, request):
          ...
          if security.is_blocked(request):
               messages.error(request,
                              "Vous n'êtes pas autorisé à utiliser ce compte")
...
class ThankYouView(ThankYouView):
     template_name = 'yous/checkout/thank_you.html'
     context_object_name = 'order'
     
class ShippingMethodView(ShippingMethodView):
     
    template_name = 'yous/checkout/shipping_methods.html'

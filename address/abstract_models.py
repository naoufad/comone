...
class AbstractShippingAddress(AbstractAddress):
    ...
    phone_number = PhoneNumberField(
        ...
        help_text=("S'il s'agit de transfert de crédit, mettez le numéro du bénéficiaire"))
    notes = models.TextField(
        blank=True, verbose_name=_('Instructions'),
        help_text=_("Dites nous tout ce qu'il savoir sur votre commande s'il vous plait"))

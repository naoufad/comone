...
class ProductDetailView(DetailView):
    ...
    template_folder = "yous/catalogue"
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx['partner']=StockRecord.objects.filter(product=self.kwargs['pk'])[0].partner
...
class CatalogueView(TemplateView):
    ...
    template_name = 'yous/catalogue/browse.html'
...
class ProductCategoryView(TemplateView):
    ...
    """
    context_object_name = "products"
    template_name = 'yous/catalogue/category.html'
    enforce_paths = True

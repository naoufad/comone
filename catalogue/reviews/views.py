...
CreateProductReview=get_class('catalogue.reviews.views',
                              'CreateProductReview')
ProductReviewList=get_class('catalogue.reviews.views',
                            'ProductReviewList')
 ProductReviewDetail=get_class('catalogue.reviews.views',
                               'ProductReviewDetail')
 
class CreateProductReview(CreateProductReview):
    template_name = "yous/catalogue/reviews/review_form.html"
    model = ProductReview
    ...
    def get_context_data(self, **kwargs):
        ...
        context['partner']=StockRecord.objects.filter(product=self.kwargs['pk'])[0].partner
        return context
...
class ProductReviewDetail(ProductReviewDetail):
    template_name = "yous/catalogue/reviews/review_detail.html"
...
class ProductReviewList(ProductReviewList):
    """
    Browse reviews for a product
    """
    template_name = 'yous/catalogue/reviews/review_list.html'
